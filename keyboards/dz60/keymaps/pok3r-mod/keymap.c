...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT(
		...
		KC_CAPS, KC_LGUI, KC_LALT, KC_SPC, KC_SPC, KC_SPC, MO(1), KC_RALT, KC_NO, MO(2), KC_RCTL),

	LAYOUT(
		KC_GRV, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, _______, KC_DEL,
		_______, KC_MPRV, KC_MPLY, KC_MNXT, RESET, _______, KC_CALC, KC_PGUP, KC_PGDN, KC_PSCR, KC_UP, KC_SLCK, KC_PAUS, _______,
		_______, KC_VOLU, KC_VOLD, KC_MUTE, _______, _______, KC_HOME, KC_INS, KC_DEL, KC_LEFT, KC_DOWN, KC_RGHT, _______,
